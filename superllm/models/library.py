...
class ModelCard:
    ...
    capabilities: dict[str, bool] = field(default_factory=lambda: {
        "chat": False, "code": False, "reasoning": False,
        "embeddings": False, "vision": False, "audio": False, "agent": False,
    })
    source: str = "local"
...
def _make(name: str, display: str, desc: str, arch: str, params: str, ctx: int,
          ...
          url: str = None, latency: str = "interactive",
          strengths: list[str] = None, weaknesses: list[str] = None,
          family: str = "", hf_repo: str = None) -> ModelCard:
    if tags is None:
        tags = []
    if caps is None:
        caps = {"chat": False, "code": False, "reasoning": False, "embeddings": False, "vision": False, "audio": False, "agent": False}
    if sizes is None:
        sizes = {}
    if quants is None:
    ...
    if weaknesses is None:
        weaknesses = []
    return ModelCard(
        name=name, display_name=display, description=desc, architecture=arch,
        parameter_count=params, context_length=ctx, category=category,
        tags=tags, capabilities=caps, source=source, provider=provider,
        recommended_ram=ram, size_estimates=sizes, quantizations=quants,
        url=url, latency_profile=latency, strengths=strengths,
        weaknesses=weaknesses, model_family=family or category, hf_repo=hf_repo,
    )
...
for _n, _d, _a, _p, _c, _cat, _tags, _caps, _ram, _sizes, _u in [
    ("qwen2.5-0.5b", "Qwen 2.5 0.5B", "qwen2", "0.49B", 32768, "chat",
     ["chat", "lightweight", "fast", "low-ram"], {"chat": True}, "1 GB",
     {"Q4_K_M": 380_000_000, "Q8_0": 620_000_000},
     "https://huggingface.co/bartowski/Qwen2.5-0.5B-Instruct-GGUF/resolve/main/Qwen2.5-0.5B-Instruct-Q4_K_M.gguf"),
    ("qwen2.5-1.5b", "Qwen 2.5 1.5B", "qwen2", "1.54B", 32768, "chat",
     ["chat", "lightweight", "fast"], {"chat": True, "code": True}, "2 GB",
     {"Q4_K_M": 930_000_000, "Q8_0": 1_600_000_000},
     "https://huggingface.co/bartowski/Qwen2.5-1.5B-Instruct-GGUF/resolve/main/Qwen2.5-1.5B-Instruct-Q4_K_M.gguf"),
    ("qwen2.5-3b", "Qwen 2.5 3B", "qwen2", "3.0B", 32768, "general",
     ["chat", "lightweight"], {"chat": True, "code": True}, "4 GB",
     {"Q4_K_M": 1_800_000_000, "Q8_0": 3_200_000_000},
     "https://huggingface.co/bartowski/Qwen2.5-3B-Instruct-GGUF/resolve/main/Qwen2.5-3B-Instruct-Q4_K_M.gguf"),
    ("qwen2.5-7b", "Qwen 2.5 7B", "qwen2", "7.61B", 32768, "general",
     ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, "8 GB",
     {"Q4_K_M": 4_600_000_000, "Q5_K_M": 5_600_000_000},
     "https://huggingface.co/bartowski/Qwen2.5-7B-Instruct-GGUF/resolve/main/Qwen2.5-7B-Instruct-Q4_K_M.gguf"),
    ("qwen2.5-14b", "Qwen 2.5 14B", "qwen2", "14.8B", 32768, "general",
     ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, "16 GB",
    ...
    ("qwen2.5-32b", "Qwen 2.5 32B", "qwen2", "32.8B", 32768, "general",
     ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, "32 GB",
    ...
    ("qwen2.5-72b", "Qwen 2.5 72B", "qwen2", "72.7B", 32768, "general",
     ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, "64 GB",
    ...
    BUILTIN_LIBRARY[_n] = _make(_n, _d, f"Alibaba's {_d.split()[-1]}.", _a, _p, _c, _cat, _tags, _caps, ram=_ram, sizes=_sizes, url=_u)

# --- Llama 3.1 ---
for _n, _d, _p, _sizes, _u in [
    ("llama3.1-8b", "Llama 3.1 8B", "8.03B",
     {"Q4_K_M": 4_900_000_000, "Q5_K_M": 6_000_000_000},
     "https://huggingface.co/bartowski/Meta-Llama-3.1-8B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-8B-Instruct-Q4_K_M.gguf"),
    ("llama3.1-70b", "Llama 3.1 70B", "70.6B",
    ...
    BUILTIN_LIBRARY[_n] = _make(_n, _d, f"Meta's {_d.split()[-1]}.", "llama", _p, 131072, "general",
        ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, ram="64 GB" if "70" in _n else "8 GB",
        sizes=_sizes, url=_u)

# --- Llama 3.2 ---
for _n, _d, _p, _c, _ram, _sizes, _u in [
    ("llama3.2-1b", "Llama 3.2 1B", "1.24B", 8192, "1 GB",
     {"Q4_K_M": 780_000_000, "Q8_0": 1_300_000_000},
     "https://huggingface.co/bartowski/Llama-3.2-1B-Instruct-GGUF/resolve/main/Llama-3.2-1B-Instruct-Q4_K_M.gguf"),
    ("llama3.2-3b", "Llama 3.2 3B", "3.21B", 8192, "4 GB",
     {"Q4_K_M": 1_900_000_000, "Q8_0": 3_400_000_000},
     "https://huggingface.co/bartowski/Llama-3.2-3B-Instruct-GGUF/resolve/main/Llama-3.2-3B-Instruct-Q4_K_M.gguf"),
]:
    BUILTIN_LIBRARY[_n] = _make(_n, _d, f"Meta's tiny {_d.split()[-1]}.", "llama", _p, _c, "chat" if "1b" in _n else "general",
        ["chat", "lightweight", "fast"], {"chat": True}, ram=_ram, sizes=_sizes, url=_u)

# --- Llama 3 ---
for _n, _d, _p, _sizes, _u in [
    ("llama-3-8b", "Llama 3 8B", "8.03B",
     {"Q4_K_M": 4_900_000_000, "Q5_K_M": 6_000_000_000},
     "https://huggingface.co/bartowski/Meta-Llama-3-8B-Instruct-GGUF/resolve/main/Meta-Llama-3-8B-Instruct-Q4_K_M.gguf"),
    ("llama-3-70b", "Llama 3 70B", "70.6B",
     {"Q4_K_M": 42_000_000_000, "Q5_K_M": 51_000_000_000},
     "https://huggingface.co/bartowski/Meta-Llama-3-70B-Instruct-GGUF/resolve/main/Meta-Llama-3-70B-Instruct-Q4_K_M.gguf"),
]:
    BUILTIN_LIBRARY[_n] = _make(_n, _d, f"Meta's {_d.split()[-1]}.", "llama", _p, 8192, "general",
        ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True},
        ram="64 GB" if "70" in _n else "8 GB", sizes=_sizes, url=_u)

# --- Mistral ---
BUILTIN_LIBRARY["mistral-7b"] = _make("mistral-7b", "Mistral 7B",
    "Mistral AI's powerful 7B.", "mistral", "7.3B", 32768, "general",
    ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, ram="8 GB",
    sizes={"Q4_K_M": 4_400_000_000, "Q5_K_M": 5_300_000_000},
    url="https://huggingface.co/bartowski/Mistral-7B-Instruct-v0.3-GGUF/resolve/main/Mistral-7B-Instruct-v0.3-Q4_K_M.gguf")

BUILTIN_LIBRARY["mixtral-8x7b"] = _make("mixtral-8x7b", "Mixtral 8x7B",
    "Mistral AI's MoE model.", "mixtral", "46.7B", 32768, "general",
    ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, ram="32 GB",
...
# --- Phi-3 ---
BUILTIN_LIBRARY["phi-3-mini"] = _make("phi-3-mini", "Phi-3 Mini",
    "Microsoft's 3.8B model.", "phi", "3.8B", 4096, "general",
    ["chat", "reasoning"], {"chat": True, "reasoning": True}, ram="4 GB",
    sizes={"Q4_K_M": 2_300_000_000, "Q8_0": 4_000_000_000},
    url="https://huggingface.co/bartowski/Phi-3-mini-4k-instruct-GGUF/resolve/main/Phi-3-mini-4k-instruct-Q4_K_M.gguf")

BUILTIN_LIBRARY["phi-3-medium"] = _make("phi-3-medium", "Phi-3 Medium",
    "Microsoft's 14B model.", "phi", "14B", 4096, "general",
    ["chat", "code", "reasoning"], {"chat": True, "code": True, "reasoning": True}, ram="16 GB",
...
# --- TinyLlama ---
BUILTIN_LIBRARY["tinyllama-1.1b"] = _make("tinyllama-1.1b", "TinyLlama 1.1B",
    "Compact 1.1B model.", "tinyllama", "1.1B", 2048, "chat",
    ["chat", "lightweight", "fast"], {"chat": True}, ram="1 GB",
    sizes={"Q4_K_M": 660_000_000, "Q8_0": 1_200_000_000},
    url="https://huggingface.co/TheBloke/TinyLlama-1.1B-Chat-v1.0-GGUF/resolve/main/tinyllama-1.1b-chat-v1.0.Q4_K_M.gguf")

# --- Audio Models ---
for _n, _d, _desc, _u in [
    ("whisper-large-v3", "Whisper Large v3", "OpenAI's speech-to-text.", "https://huggingface.co/ggerganov/whisper.cpp"),
    ("whisper-small", "Whisper Small", "OpenAI's compact STT.", "https://huggingface.co/ggerganov/whisper.cpp"),
    ("faster-whisper", "Faster Whisper", "Fast Whisper reimplementation.", "https://huggingface.co/guillaumeklf/faster-whisper-large-v3"),
    ...
    BUILTIN_LIBRARY[_n] = _make(_n, _d, _desc, _n.split("-")[0], "1.5B", 224, "audio",
        ["audio", "speech"], {"audio": True}, ram="4 GB", url=_u)

# --- Agent Models ---
for _n, _d, _desc, _u in [
    ("hermes-2-pro", "Hermes 2 Pro", "Nous Research's function-calling model.", "https://huggingface.co/NousResearch/Hermes-2-Pro-Mistral-7B-GGUF"),
    ("openchat-3.5", "OpenChat 3.5", "OpenChat's 7B.", "https://huggingface.co/openchat/openchat_3.5"),
    ("openchat-3.6", "OpenChat 3.6", "OpenChat's 8B.", "https://huggingface.co/openchat/openchat-3.6-8B-20240522"),
]:
    BUILTIN_LIBRARY[_n] = _make(_n, _d, _desc, "hermes" if "hermes" in _n else "openchat", "7B", 32768, "agent",
        ["agent", "chat"], {"chat": True, "code": True, "agent": True}, ram="8 GB", url=_u)
...
for _n, _d, _p, _u in [
    ...
    BUILTIN_LIBRARY[_n] = _make(_n, _d, f"Multimodal {_d}.", _n.split("-")[0], _p, 8192, "vision",
        ["vision", "multimodal"], {"chat": True, "vision": True}, ram="8 GB", url=_u)

# --- Specialized ---
for _n, _d, _desc, _u in [
    ("sqlcoder", "SQLCoder", "Defog's text-to-SQL model.", "https://huggingface.co/defog/sqlcoder-7b-2"),
    ("meditron-7b", "Meditron 7B", "EPFL's medical domain model.", "https://huggingface.co/epfl-llm/meditron-7b"),
]:
    BUILTIN_LIBRARY[_n] = _make(_n, _d, _desc, _n.split("-")[0], "7B", 4096, "specialized",
        ["specialized"], {"chat": True}, ram="8 GB", url=_u)
...
for _n, _d, _desc, _provider in [
    ...
    ("claude-3.5-sonnet:cloud", "Claude 3.5 Sonnet (Cloud)", "Anthropic's balanced model.", "anthropic"),
    ...
    ("deepseek-r1-671b:cloud", "DeepSeek R1 671B (Cloud)", "DeepSeek's reasoning model.", "together"),
    ("qwen3-thinking-max:cloud", "Qwen 3 Thinking Max (Cloud)", "Alibaba's thinking model.", "together"),
]:
    BUILTIN_LIBRARY[_n] = _make(_n, _d, _desc, _n.split(":")[0], "unknown", 131072, "general",
        ["chat", "code", "reasoning", "cloud"], {"chat": True, "code": True, "reasoning": True},
        source="cloud", provider=_provider, ram="Cloud")
...
class ModelLibrary:
    ...
    def search(query: str = "") -> list[ModelCard]:
        ...
        for card in BUILTIN_LIBRARY.values():
            if q in card.name.lower() or q in card.display_name.lower() or q in card.description.lower():
                results.append(card)
                continue
    ...
    def recommend_for_hardware(ram_gb: float) -> list[ModelCard]:
        def parse_ram(ram: str) -> float:
            ...
            try:
                ...
                return float("inf")
        r = [m for m in BUILTIN_LIBRARY.values() if parse_ram(m.recommended_ram) <= ram_gb and m.source == "local"]
        return sorted(r, key=lambda x: parse_ram(x.recommended_ram))

    @staticmethod
    def recommend_for_task(task: str, ram_gb: float = 8.0) -> list[ModelCard]:
        cap_map = {"chat": "chat", "code": "code", "reasoning": "reasoning",
                   "vision": "vision", "audio": "audio", "agent": "agent"}
